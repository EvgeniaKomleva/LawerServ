...
class BillListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        page_title = 'Лицензионный договор'
...
class PayrollListView(ListView):
    model = Payroll
    template_name = 'SrokiList.html'#'page_list.html'
    paginate_by = 100
...
class ExpensesListView(ListView):
    ...
    template_name = 'FormaPretenzii.html'#page_list.html'
    paginate_by = 100
